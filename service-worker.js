...
const urlsToCache = [
  ...
  'https://sanaeih1.github.io/Dialysis03/assets/font-size.png',
  'https://sanaeih1.github.io/Dialysis03/assets/sodium.png',
  'https://sanaeih1.github.io/Dialysis03/assets/potassium.png',
  'https://sanaeih1.github.io/Dialysis03/assets/phosphorus.png',
  'https://sanaeih1.github.io/Dialysis03/assets/protein.png',
  'https://sanaeih1.github.io/Dialysis03/assets/water.png',
  'https://sanaeih1.github.io/Dialysis03/assets/energy.png',
    ...
    caches.match(event.request)
      .then(response => {
        ...
        return fetch(event.request)
          ...
          .catch(() => {
            return caches.match('https://sanaeih1.github.io/Dialysis03/index.html');
          });
      })
  );
});
